...
// Icons
import { Eye, Copy, X, Target, Trash2, Plus as PlusIcon, Minus as MinusIcon } from 'lucide-react';
...
import PanelHeader from './components/PanelHeader.module.css';
...
import type { BackgroundLayer } from './components/Background/Background';
import Filters from './components/Filters/Filters';
import type { FiltersValues } from './components/Filters/Filters';
import Shadows from './components/Shadows/Shadows';
import type { ShadowsValues } from './components/Shadows/Shadows';
import BoxShadows from './components/BoxShadows/BoxShadows';
import Positioning from './components/Positioning/Positioning';
import type { PositioningValues } from './components/Positioning/Positioning';
import Border from './components/Border/Border';
import type { BorderValues } from './components/Border/Border';
    ...
    <>
      ...
      <div 
        ...
        className={`${Panel.base} ${
          isDraggingPanel ? `${Panel.scaleOnDrag}` : `${Panel.hoverShadow}`
        } ${
          isMinimized 
            ? `${Panel.minimized}` 
            : `${Panel.normal}`
      ...
      >
        ...
        {isMinimized ? (
          <div 
            className={`${PanelHeader.panel}  minimized-panel`}
           
            onMouseDown={handlePanelDragStart}
          >
            <div className={`${PanelHeader.flexGap2ItemsCenter}`}>
              <div>
                <LogoApp variant="white" size={82} className={`${PanelHeader.logoApp}`}/>
              </div>
              {/* Ícono de inspector */}
              <div className={clsx(
                PanelHeader.inspectorIcon,
                isInspectorMode ? PanelHeader.inspectorIconActive : PanelHeader.inspectorIconInactive
              )} />

              {/* Ícono de notificación */}
              <div className={clsx(
                PanelHeader.inspectorIcon,
                selectedElement ? PanelHeader.inspectorIconActive : PanelHeader.inspectorIconInactive
              )} />
            ...
            <div className={`${PanelHeader.flexGap1ItemsCenter}`}>
              ...
              <button
                ...
                className={`${PanelHeader.expandBtn}`}
                title="Expand panel"
              >
          ...
          <>
            {/* Drag handle visible */}
            <div 
              className={`${PanelHeader.dragHandle} drag-handle`}
              onMouseDown={handlePanelDragStart}
            />
